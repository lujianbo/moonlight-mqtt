...
public abstract class MQTTProtocol {
    ...
    public static final byte mostOnce = 0x00;
    public static final byte leastOnce = 0x01;
    public static final byte exactlyOnce = 0x02;
    public static final byte reserved = 0x03;
}
